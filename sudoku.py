"""
This program is the game of Sudoky. You need to run this file to start the game.
This file primarily deals with GUI interaction of the user with the game. Functions 
that process the information and display it on the window are in backened.py file.
The goal of this implementation is to visualize backtracking algorithm.
